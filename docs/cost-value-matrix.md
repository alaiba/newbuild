...
| Case / airflow | TBD | TBD | TBD | Avoided thermal throttling only if relevant | Dust, fan life, accessibility and temperatures TBD | Future GPU/radiator/storage fit TBD | Open |
